...
//  et ses 2 fils : la séquence d'instruction du repeter et la condition associée
  public:
   ...
   ~NoeudInstRepeter() {} // A cause du destructeur virtuel de la classe Noeud
    int executer();  // Exécute l'instruction repeter : au moins une fois puis tant que condition vraie on exécute la séquence
...
//  et ses 4 fils : la séquence d'instruction du pour, l'initialisation, la condition et l'affectation associées
  public:
    NoeudInstPour(Noeud* initialisation, Noeud* condition,  Noeud* affectation, Noeud* sequence);
