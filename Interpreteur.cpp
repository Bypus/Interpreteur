...
Noeud* Interpreteur::instPour() {
    ...
    return new NoeudInstPour(initialisation, condition, affect, sequence); // Et on renvoie un noeud Instruction Pour
...
Noeud* Interpreteur::instEcrire(){
    ...
    if(m_lecteur.getSymbole() == "<CHAINE>"){
        aEcrire.push_back(m_table.chercheAjoute(m_lecteur.getSymbole().getChaine()));       
        m_lecteur.avancer();
    }
    else {
        aEcrire.push_back(expression());
    }
